...
This document aims at presenting the numerical implementation accomplished in the
article entitled *Why a Mickael Marsh is always needed?* by Solarik et al. paper[^tobeadded]. The lines below detail the steps needed to obtain the results.


## The Study

In Solarik et al. 2017 the authors explain the number of seedlings of different species of one or two ages on three sites (see data section) in quadrats of 1x1m (hereafter plots).

| Ecological process  |abbr  |number of paramters|
|:--------------------|:-----|:------------------|
| dispersion          |disp  |2                  |
...
| Name     |abbr | Longitude | Latitude | Number of plots |  
|:-------- |:--- |:----------|:---------|:----------------|
| Abitibi  |abi  | xxx       | xxx      | xxx             |
| Le Bic   |bic  | xxx       | xxx      | xxx             |
| Sutton   |sut  | xxx       | xxx      | xxx             |
...
: abbreviations, names, TSN (Taxonomic Serial Number) of the tree species considered and their respective presence in the three sites of the study.
