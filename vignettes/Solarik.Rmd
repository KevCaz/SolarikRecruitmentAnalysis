...
Note that we stored all these data as `.rda` files in `data` (see, for instance, `?dat_abitibi`).
...
Once all models run and the best models identified, we draw figure 5 that is the dispersal kernels inferred for one year seedlings
