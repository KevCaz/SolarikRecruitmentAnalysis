...
# Few notes about the paper

This vignette aims at guiding the reader through the different steps of
the analysis we carried out in Solarik *et al.* XXXX. Data and R code to
reproduce our analyse and this vignette are available at
[https://github.com/KevCaz/seedlingsRecruitmentAnalysis](https://github.com/KevCaz/seedlingsRecruitmentAnalysis).
...
We benefited from Compute Canada facilities (Mammoth super computer, Compute Canada).
