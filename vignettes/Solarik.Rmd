...
<!-- save(dat_abitibi, file = "data/dat_abitibi.rda", compress = "xz",
  version = 2)
...
Note that we stored all these data as `.rda` files in `data`.
...
For instance, below are the 15 first models out of the `r nrow(simuDesign)/7`
